...
def get_next_prayer_time(timings):  # Функция для получения следующего времени молитвы
...
def create_window(timings, hijri_date): # Функция для создания окна
    ...
    def update_next_prayer_time():  # Функция для обновления времени до следующей молитвы
    ...
    update_next_prayer_time() # Вызываем функцию обновления времени до следующей молитвы
